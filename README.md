...
3. I installed Debian on the other machine, and created a splunk user. Had an issue where the machien would go to sleep after some time as well as after an ssh session ends. This just required some adjustments to systemd/logind.conf.
